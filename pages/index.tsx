...
const Home: NextPage<Props> = ({ recentSongs, popSongs, rockSongs }) => {
                        ...
                        client
                            ...
                            .then(
                                (
                                    ...
                                    const { username, image, _id, libraryId } =
                                        response[0];
                            ...
                            .finally(() =>
                                dispatch(fetchingUserDataAttemptFinished())
                            );
                    }
                }
            }
    ...
    return (
        <>
            ...
            <main className="min-w-screen min-h-screen bg-darkBlue text-white overflow-x-hidden pb-64">
                ...
                <footer className="flex flex-row p-4 justify-end">
                    <a
