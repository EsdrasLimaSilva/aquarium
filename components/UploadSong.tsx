    ...
    function setSong(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        if ((file && type === "audio/mpeg") || type === "audio/mp3") {
            ...
            client.assets
                ...
                .then((res: { url: string; _id: string }) => {
                    dispatch(
                        songAssetSet({ url: res.url, id: res._id, name: name })
                    );
                })
        ...
        >
            ...
            >
                {processingImage ? (
                    ...
                    <label className="w-60 h-44 bg-blue flex flex-col justify-center items-center cursor-pointer">
                ...
                {processingSong ? (
                    <div className="w-60 bg-orange-600 text-white p-2 my-5 flex justify-center items-center">
                        <ImSpinner9 className="animate-spin" />
                    </div>
                ) : songProcessed ? (
                    <div className="w-60 bg-orange-600 text-white p-2  my-5">
                    ...
                    <label className="w-60 bg-orange-600 text-white px-2 my-5 cursor-pointer">
                        <p className="flex flex-row items-center justify-center py-2">
                            choose a song{" "}
                            <RiFolderUploadFill className="ml-2" />
                        </p>
                        <input
                            type="file"
                ...
                <label className="my-3 w-full">
                    ...
                    <input
                        type="text"
                        required
                        className="outline-none text-darkBlue rounded-none"
                    />
                </label>
                ...
                <label className="my-3 w-full">
                    ...
                    <textarea
                        cols={30}
                        rows={5}
                        className="outline-none text-darkBlue w-full p-2"
                    ></textarea>
                </label>
                ...
                {uploadingSong ? (
                    <button
                        type="submit"
                        className="my-16 bg-white w-fit px-3 py-1 text-darkBlue opacity-60 flex flex-row items-center justify-center"
                        disabled
                    >
                    ...
                    <button
                        type="submit"
                        className="my-16 bg-white w-fit px-3 py-1 text-darkBlue"
                    >
                        upload song
                    </button>
                )}
